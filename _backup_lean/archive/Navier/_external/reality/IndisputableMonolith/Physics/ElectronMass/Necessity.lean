...
/-- φ^(-20.7063) > 4.705e-5 (empirical numeric fact) -/
axiom phi_pow_neg207063_lower : (4.705e-5 : ℝ) < phi ^ (-20.7063 : ℝ)

/-- φ^(-20.705) < 4.709e-5 (kept as empirical numeric fact) -/
axiom phi_pow_neg20705_upper : phi ^ (-20.705 : ℝ) < (4709 / 100000000 : ℝ)
