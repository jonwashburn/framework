...
axiom mp_forces_nontrivial_conservation_axiom
    (E : DiscreteEventSystem) (ev : EventEvolution E)
    (hMP : Recognition.MP)
    [LocalFinite E ev]
...
theorem mp_forces_nontrivial_conservation
    ...
    (hNontrivialSystem : ∃ e₁ e₂ : E.Event, e₁ ≠ e₂ ∧ ev.evolves e₁ e₂) :
    ∃ f : FlowFS E ev, ConservationLawFS E ev f ∧ NonTrivialFlow f :=
  mp_forces_nontrivial_conservation_axiom E ev hMP hNontrivialSystem
...
axiom nontrivial_flow_has_inoutflow
    (E : DiscreteEventSystem) (ev : EventEvolution E) (f : FlowFS E ev) :
...
theorem structured_conservation_from_mp
  ...
  classical
  obtain ⟨f, hCons, hNonTriv⟩ := mp_forces_nontrivial_conservation E ev hMP hNontrivialSystem
  exact ⟨f, hCons, nontrivial_flow_has_inoutflow E ev f hNonTriv⟩
