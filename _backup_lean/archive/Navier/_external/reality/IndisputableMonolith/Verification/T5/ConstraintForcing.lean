...
-/
theorem cosh_add_is_math_not_physics :
    -- The Cosh-Add identity is a consequence of:
    -- 1. Symmetry (from ledger)
    -- 2. Unit (from ledger)
    -- 3. Continuity (physical requirement)
    -- 4. Curvature normalization (gauge)
    True := trivial  -- Documented in LedgerCost.cosh_add_is_mathematical_consequence
