...
theorem null_only_stepbounds (cp : ConsciousProcess) [wf : ConsciousProcess.WellFormed cp]
  ...
  intro hdisp
  -- Bind to cone lemmas explicitly (not needed for this scaffold proof)
  have _ := LightCone.StepBounds.reach_time_eq H
  have _ := LightCone.StepBounds.reach_rad_le H
