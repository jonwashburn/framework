...
/-- For Minkowski, □ = -∂₀² + ∂₁² + ∂₂² + ∂₃² in coordinates.
    NOTE: Full proof requires inverse Minkowski metric expansion. -/
...
/-- Variational principle: stationary action implies Euler-Lagrange equation (discrete form).
    NOTE: Full proof requires functional calculus and integration by parts. -/
axiom variational_principle (ψ : Fields.ScalarField) (g : MetricTensor) (m_squared : ℝ)
    (vol : VolumeElement) :
