...
structure PhotonChannel where
  ...
  /-- Massless (null propagation): field strength satisfies the wave equation. -/
  massless : ∀ x, let □ := @HasCoboundary.d mesh coboundary 2 ∘ @HasHodge.star mesh hodge 2 ∘ @HasCoboundary.d mesh coboundary 1
                 ∃ (A_field : DForm mesh 1), F = HasCoboundary.d A_field ∧ (□ A_field) x = 0
