...
/-!
Differentiability along LA-projected feasible paths (documentation / TODO).

This placeholder was previously a `True := trivial` theorem. The intended statement is a real
regularity theorem about the existence of directional derivatives along feasible, LA-projected
paths at σ=0.
-/
