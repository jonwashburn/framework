...
def lStep_budget_nonincreasing_within_window_hypothesis : Prop :=
  ∀ (P : LProgram) (s : LState),
...
theorem lStep_budget_nonincreasing_within_window (P : LProgram) (s : LState)
    ...
    lStep_budget_nonincreasing_within_window_hypothesis →
      (lStep P s).jBudgetWin ≤ s.jBudgetWin := by
  intro h
  exact h P s h_no_rollover
...
lemma lStepJ_nonincreasing (P : LProgram) (s : LState)
  ...
  calc (jBudgetUpdate P (lStep P s)).jBudgetWin
    ...
    _ ≤ s.jBudgetWin := (lStep_budget_nonincreasing_within_window P s h_no_rollover) h_within
...
def jBudget_nonincreasing_over_window_hypothesis : Prop :=
  ∀ (P : LProgram) (s : LState) (n : ℕ),
    ((lStepJ P)^[n] s).jBudgetWin ≤ s.jBudgetWin

lemma jBudget_nonincreasing_over_window (P : LProgram) (s : LState) (n : ℕ) :
    jBudget_nonincreasing_over_window_hypothesis →
...
lemma lCycleJ_nonincreasing (P : LProgram) (s : LState) :
  ...
  intro h
  unfold lCycleJ
  exact (jBudget_nonincreasing_over_window P s 8) h
