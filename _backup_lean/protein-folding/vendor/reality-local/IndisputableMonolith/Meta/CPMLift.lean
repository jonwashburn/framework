...
, gap45 := fun φ => RH.RS.fortyfive_gap_spec_holds φ
, inevitabilityDimless := fun φ => RH.RS.inevitability_dimless_holds φ
, inevitabilityAbsolute := fun φ => RH.RS.inevitability_absolute_holds φ
