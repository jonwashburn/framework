...
structure DerivesObservables (F : PhysicsFramework) : Prop where
  ...
  derives_alpha : ∃ (_ : ℝ), True  -- DEPRECATED: trivially true
  /-- Can predict mass ratios -/
  derives_masses : ∃ (_ : List ℝ), True  -- DEPRECATED: trivially true
