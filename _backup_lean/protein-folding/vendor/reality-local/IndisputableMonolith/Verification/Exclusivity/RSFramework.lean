...
noncomputable def toPhysicsFramework (φ : ℝ) (F : RH.RS.ZeroParamFramework φ) : PhysicsFramework where
  StateSpace := Bool
  evolve := not
  Observable := Unit
  measure := fun _ => ()
...
instance (φ : ℝ) (F : RH.RS.ZeroParamFramework φ) : Inhabited (toPhysicsFramework φ F).StateSpace := ⟨false⟩

instance (φ : ℝ) (F : RH.RS.ZeroParamFramework φ) : NonStatic (toPhysicsFramework φ F) := by
  refine ⟨⟨false, ?_⟩⟩
...
noncomputable def canonicalConnection
    (φ : ℝ) (F : RH.RS.ZeroParamFramework φ) :
...
noncomputable def derivesObservables (φ : ℝ) (F : RH.RS.ZeroParamFramework φ) :
    DerivesObservables (toPhysicsFramework φ F) :=
  { derives_alpha := ⟨0, trivial⟩
...
noncomputable def hasZeroParameters (φ : ℝ) (F : RH.RS.ZeroParamFramework φ) :
...
noncomputable def hasSelfSimilarity (φ : ℝ) (F : RH.RS.ZeroParamFramework φ) :
...
noncomputable def rs_assumptions (φ : ℝ) (F : RH.RS.ZeroParamFramework φ) :
