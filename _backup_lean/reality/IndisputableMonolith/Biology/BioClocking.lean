...
theorem molecularGate_approx : 60e-12 < physicalTimescale 19 ∧ physicalTimescale 19 < 80e-12 := by
  ...
  have h_low_pow : (1.61803395 : ℝ) ^ (19 : ℕ) < phi ^ (19 : ℕ) := by
    exact pow_lt_pow_left₀ hφ.1 (by norm_num) (by decide : (19 : ℕ) ≠ 0)
  have h_high_pow : phi ^ (19 : ℕ) < (1.6180340 : ℝ) ^ (19 : ℕ) := by
    have hlt : phi < (1.6180340 : ℝ) := hφ.2
    exact pow_lt_pow_left₀ hlt (le_of_lt phi_pos) (by decide : (19 : ℕ) ≠ 0)
  -- Numeric envelopes for the boundary powers
  have h_num_low : (8300 : ℝ) < (1.61803395 : ℝ) ^ (19 : ℕ) := by norm_num
  have h_num_high : (1.6180340 : ℝ) ^ (19 : ℕ) < (10900 : ℝ) := by norm_num
...
theorem coherenceLimit_approx : 15e-6 < physicalTimescale 45 ∧ physicalTimescale 45 < 25e-6 := by
  have hφ := phi_tight_bounds
  have h_low_pow : (1.61803395 : ℝ) ^ (45 : ℕ) < phi ^ (45 : ℕ) := by
    exact pow_lt_pow_left₀ hφ.1 (by norm_num) (by decide : (45 : ℕ) ≠ 0)
  have h_high_pow : phi ^ (45 : ℕ) < (1.6180340 : ℝ) ^ (45 : ℕ) := by
    have hlt : phi < (1.6180340 : ℝ) := hφ.2
    exact pow_lt_pow_left₀ hlt (le_of_lt phi_pos) (by decide : (45 : ℕ) ≠ 0)
  have h_num_low : (2.3e9 : ℝ) < (1.61803395 : ℝ) ^ (45 : ℕ) := by norm_num
  have h_num_high : (1.6180340 : ℝ) ^ (45 : ℕ) < (2.9e9 : ℝ) := by norm_num
...
theorem neuralSpike_approx : 0.7e-3 < physicalTimescale 53 ∧ physicalTimescale 53 < 1e-3 := by
  have hφ := phi_tight_bounds
  have h_low_pow : (1.61803395 : ℝ) ^ (53 : ℕ) < phi ^ (53 : ℕ) := by
    exact pow_lt_pow_left₀ hφ.1 (by norm_num) (by decide : (53 : ℕ) ≠ 0)
  have h_high_pow : phi ^ (53 : ℕ) < (1.6180340 : ℝ) ^ (53 : ℕ) := by
    have hlt : phi < (1.6180340 : ℝ) := hφ.2
    exact pow_lt_pow_left₀ hlt (le_of_lt phi_pos) (by decide : (53 : ℕ) ≠ 0)
  have h_num_low : (1.0e11 : ℝ) < (1.61803395 : ℝ) ^ (53 : ℕ) := by norm_num
  have h_num_high : (1.6180340 : ℝ) ^ (53 : ℕ) < (1.3e11 : ℝ) := by norm_num
