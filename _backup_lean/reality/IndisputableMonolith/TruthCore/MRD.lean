...
structure MeasurementMap where
  toBands : IndisputableMonolith.Bridge.BridgeData → RecogSpec.Bands → Prop
  invariant_under_units : ∀ {U U'} (h : IndisputableMonolith.Verification.UnitsRescaled U U') (X : RecogSpec.Bands),
