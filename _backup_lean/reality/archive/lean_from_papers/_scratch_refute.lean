...
-- reuse the lemmas from the scratch files (copy-paste)
...
-- amplitude lower bound (copy from _scratch_amp_lb2.lean)
open Complex
...
lemma phiDFTAmplitude_one_gt_38 : (38 : ℝ) < phiDFTAmplitude (1 : Fin 8) := by
  ...
  -- now translate to phiDFTAmplitude
