...
theorem field_eqs_gr_limit (h : H_FieldEquationsGRLimit g ψ vol) (g : MetricTensor) (ψ : Fields.ScalarField) (vol : VolumeElement) :
    FieldEquations g ψ vol 0 0 →
...
theorem variation_gives_equations (h : H_VariationGivesEquations g ψ vol α m_squared) (g : MetricTensor) (ψ : Fields.ScalarField)
...
theorem einstein_implies_conservation (h : H_EinsteinImpliesConservation g ψ vol α m_squared)
