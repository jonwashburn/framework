...
theorem ricci_scalar_variation (g : MetricTensor) (μ ν : Fin 4) (x : Fin 4 → ℝ) :
  ...
  unfold ricci_scalar
  -- Use functional_deriv_sum and functional_deriv_mul
  -- Functional derivative of the sum Σ g^μ'ν' R_μ'ν'
  -- Term 1: R_μ'ν' δg^μ'ν'/δg^μν picks out R_μν.
  -- Term 2: g^μ'ν' δR_μ'ν'/δg^μν is a total divergence.
  sorry
