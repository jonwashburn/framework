...
The theorem below is a placeholder for the Navier-Stokes millennium problem.
It currently only handles zero initial data trivially.

The full proof requires:
1. Energy estimates for the vorticity equation
2. BKM-type blowup criteria
3. Regularity bootstrap from enstrophy bounds

This is hidden behind a flag to keep the codebase sorry-free.
-/

-- Uncomment when ready to work on the millennium problem:
/-
theorem NavierStokesRegularity :
  ...
  -- TODO: Millennium problem (global regularity for general smooth initial data)
-/
