...
The final passage from analytic to algebraic cycles uses Chow's theorem and GAGA. \REV{\cite{Hartshorne77,GH78,Serre56,Chow49}}.
\end{abstract}
...
By Hard Lefschetz \REV{(see, e.g., \cite{Voisin02,GH78,Wells})} (Remark~\textup{(Lefschetz reduction remark; proved later)}), it suffices to treat the range $p\le n/2$.
...
This is standard; see \REV{\cite{Hartshorne77,GH78,Serre56}}\REV{,\cite{Chow49}}. \end{remark}
