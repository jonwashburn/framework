...
\small
\noindent\textit{Design note:} This manuscript presents a standards-ready, audit-first blueprint for abiogenesis grounded in Recognition Science (RS). It emphasizes falsifiable predictions, portable instrumentation, and safety-by-design.
\end{minipage}
\end{center}
