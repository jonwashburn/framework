...
\begin{definition}[Recognition Composition Law on $\Rpos$]
A function $F: \Rpos \to \R$ satisfies the \emph{Recognition Composition Law} if for all $x, y > 0$:
\begin{equation}
...
\begin{enumerate}[nosep]
    ...
    \item The Recognition Composition Law.
