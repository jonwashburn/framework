...
\label{eq:weight}
\end{equation}
This multiplicative form ensures that each physical effect contributes independently (in log space, the effects add). \RScom{GP-2026-01-03-200: VERIFIED. Lean WeakField.lean has matching multiplicative structure: w\_eff = lam * xi * n * (Tdyn/tau0)\^{}alpha * zeta. Acceleration param (a0/a)\^{}alpha bridges to time param via ParameterizationBridge.lean. See Claim 3.1.} We now explain the role of each factor:
