...
/-- All operators are trivially invertible in the placeholder model.
    The invertible fields are of type `True`, witnessed by their construction. -/
theorem operators_have_inverses : True ∧ True ∧ True ∧ True :=
  ⟨LOCK.invertible, BALANCE.invertible, FOLD.invertible, BRAID.invertible⟩
