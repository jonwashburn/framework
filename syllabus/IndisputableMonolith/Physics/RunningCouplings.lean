...
This is a **derived** value, NOT a fit parameter:
- The coefficient 11 comes from `passive_field_edges(D=3) = 12 - 1 = 11`
- The factor 2π is the standard normalization in QFT conventions
- This matches the Standard Model's QCD beta function coefficient b₀ = 11 - 2n_f/3 -/
