...
structure MetricCompatible (R_cmp : ComparativeRecognizer C E) (gt_events : Set E)
  ...
  /-- If the recognizer *separates* `c₁,c₂`, then their distance is strictly positive. -/
  dist_pos_of_separated : ∀ {c₁ c₂ : C}, SeparatedBy R_cmp gt_events c₁ c₂ → 0 < d c₁ c₂
...
theorem metric_from_comparisons {ι : Type*} [Nonempty ι]
  ...
  exact (hcompat i).dist_pos_of_separated hsep_i
