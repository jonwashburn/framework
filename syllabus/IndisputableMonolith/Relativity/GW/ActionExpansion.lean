...
def expand_action_around_FRW (scale : ScaleFactor) (psi : Fields.ScalarField) (α C_lag : ℝ) : Prop :=
  True

def isolate_tensor_contribution (scale : ScaleFactor) (h : TensorPerturbation) : Prop :=
  True
...
def action_form_verified (scale : ScaleFactor) (h : TensorPerturbation) (α C_lag : ℝ) : Prop :=
  True
